...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  watch: {
    $route: function $route(to, from) {
      console.log("Route changed from ".concat(from.path, " to ").concat(to.path));
    }
  },
  data: function data() {
    return {
  ...
  methods: {
    getList: function getList() {
      var _this = this;
      this.loading = true;
      _common_api_service__WEBPACK_IMPORTED_MODULE_0__["default"].query('/api/admin/module', {
        params: {
          type: 'treeData'
        }
      }).then(function (_ref) {
    ...
    return [_vm.ListModule.includes(item.code) ? _c(item.children.length > 0 ? "el-submenu" : "el-menu-item", {
      ...
      return _vm.ListModule.includes(item2.code) ? _c(item2.children.length > 0 ? "el-submenu" : "el-menu-item", {
        ...
        return _vm.ListModule.includes(item3.code) ? _c(item3.children.length > 0 ? "el-submenu" : "el-menu-item", {
          ...
          "class": item3.icon ? item3.icon : "el-icon-setting"
        }), _vm._v(" "), _c("span", [_vm._v(_vm._s(item3.name))])])], 2) : _vm._e();
      })], 2) : _vm._e();
    })], 2) : _vm._e()];
  })], 2) : _vm._e()], 1)]);
};
