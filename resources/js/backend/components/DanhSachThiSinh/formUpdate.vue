                            ...
                            <el-form label-position="right" :model="formData" :rules="rules" ref="formData"
                                ...
                                <el-form-item label="Khối thi" prop="maKhoiThi">
                                    <div class="form-group">
                                        <el-select :disabled="true" style="width: 100%" v-model="formData.maKhoiThi" size="large"
                                                   filterable 
                                ...
                                <el-form-item label="Năm học" prop="maNamHoc">
                                    <div class="form-group">
                                        <el-select :disabled="true" style="width: 100%" v-model="formData.maNamHoc" size="large"
                                                   filterable 
...
export default {
    ...
    async mounted() {
        ...
        if(this.$route.params.maNamHoc &&  this.$route.params.maKhoiThi ){
            this.formData.maKhoiThi = this.$route.params.maKhoiThi 
            this.formData.maNamHoc = this.$route.params.maNamHoc 
            await this.getDanhSachThiSinh()
        }
